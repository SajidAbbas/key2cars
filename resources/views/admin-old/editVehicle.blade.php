    ...
    <section class="content">
      <!-- /.box -->
          ...
          <div class="nav-tabs-custom">
            ...
            @foreach($result as $r)
            <form  method="post" id="form" action="{{ route('updateVehicle')}}"   enctype = "multipart/form-data" autocomplete="off">
             {{ csrf_field() }}
            ...
            <div id="ddlSocial"></div>  
              ...
              <!-- text input -->
               <div class="form-group">
                ...
                <option selected="selected"  value="{{$r->vehicle_type_id}}">{{$r->vehicle_type}}</option>
                
                @foreach($type as $t)
                  
                  @if($t->title!=$r->vehicle_type)
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <option selected="selected" disabled="disabled"  value="{{$r->color_id}}">{{$r->color}}</option>
          ...
          <!-- /.row -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <option selected="selected"  disabled="disabled" value="{{$r->transmission_id}}">{{$r->transmission}}</option>
                ...
                <select name="assembly" class="form-control select2"  style="width: 100%;">
                   <option selected="selected" disabled="disabled"  value="{{$r->assembly_id}}">{{$r->assembly}}</option>
