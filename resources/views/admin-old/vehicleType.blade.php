...
<title>AdminK2C | VehicleType</title>
...
<a href="{{ route('addVehicleType') }}" class="btn bg-blue">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><img src="{{URL :: asset('images'.$d->icon_url) }}" alt="no image"/></td>     
                  <td>{{$d->title}}</td> 
                  <td style=" vertical-align: middle"><a class="btn btn-default" href="{{Route('editVehicleType', ['id' => $d->id])}}"><i class="fa fa-pencil"></i> Edit</a>
                  </td>
                </tr>
                <?php $serial++;?>
                @endforeach
...
function deleteRecord(ids)
    ...
    buttons: {
        confirm: function () {
			var data = { 'id': ids };
        $.get('deleteVehicleType', data, function (data) {
