...
<title>Admin | ADS/Accessory</title>
@endsection
            ...
            <div class="box-body">
              <table class="table table-bordered" id="example">
                ...
                <tr>
                  ...
                  <td style=" vertical-align: middle">{{$d->category}}</td> 
                  <td style=" vertical-align: middle">{{$d->sub_category}}</td>
                  ...
                  <td style=" vertical-align: middle"><a class="btn btn-default" href="{{Route('editAccessory',['id'=>$d->id])}}"><i class="fa fa-pencil"></i> Edit</a>
                  </td>
                 
                 
                 
                  <td style="vertical-align: middle"><a class="btn btn-default" href="{{Route('detailAccessory',['id'=>$d->id])}}"><i class="fa fa-eye"></i> View</a></td>
  ...
  $.confirm({
    ...
    buttons: {
      ...
      var data = { 'value': val,'id':id };
        $.get('/updateRequestAccessory', data, function (data) {
...
function deleteRecord(ids)
  {
    ...
    buttons: {
        confirm: function () {
      var data = { 'id': ids };
        $.get('/deleteAccessoryModerator', data, function (data) {
