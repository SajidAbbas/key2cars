...
<title>Admin | Condition Detail</title>
@endsection
...
Save
    ...
    <section class="content">
      <!-- /.box -->
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"> Edit Condition Detial</a></li>   
            </ul>
     ...
     <div class="row">
         ...
         <!-- Horizontal Form -->
            <!-- form start -->
            <form  method="post" id="form" action="{{route('updateConditionDetail')}}"  class="form-horizontal" autocomplete="off">
            @foreach($result as $r)
             {{ csrf_field() }}
              <div class="box-body">
