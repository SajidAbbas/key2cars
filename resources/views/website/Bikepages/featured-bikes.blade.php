...
@section('title')
Featured Bike for Sale in Pakistan  | Key2Cars
@endsection
...
<div class="" id="main-container"> 
  <!--<form class="form-horizontal hidden-lg hidden-md hidden-sm" id="searchForm" method="post" action="http://localhost:8000/Cars/Serach#result" role="form">
        ...
        <h2 style="text-align:center;">Find Bikes for Sale in Pakistan</h2>
...
<div class="" tabindex="0">
  <div id="used-cars">
       <form method="post" action="{{route('searchFeaturedBikesByAllFilters')}}#result" >
   {{ csrf_field() }}
...
<section class="m-top-10">
  <div class="container">
    <div class="used-car-search-results"> 
        ...
        <h1>Featured  Bikes By City | Make <span style="font-weight: normal;"></span></h1>
      <div class="related_searches primary-lang" data-pjax-enable>
        ...
        <div class="p15 fs12">
          <ul class="list-unstyled nomargin row generic-light-grey">
            ...
            <li class="col-md-3"> <a  href="{{Route('/FeaturedBikesByCity', ['id' => $c_v_c->id])}}#result" id="{{$c_v_c->id}}" title="Cars for sale in {{$c_v_c->title}}">Cars {{$c_v_c->title}}</a> ({{$c_v_c->size}}) </li>
            @endforeach
          </ul>
        </div>
        <hr class="nomargin"/>
        <div class="p15 fs12">
          <ul class="list-unstyled nomargin row generic-light-grey" >
            @foreach($manufacture_featured_bikes as $m_f_c)
            <li class="col-md-3"> <a href="{{Route('/FeaturedBikesByManufacture', ['id' => $m_f_c->id])}}#result" id="{{$m_f_c->id}}" title="{{$m_f_c->title}} Cars for sale in Pakistan">{{$m_f_c->title}} Cars</a> ({{$m_f_c->size}}) </li>
            @endforeach
          </ul>
        </div>
        <hr class="nomargin"/>
                        ...
                        <div class="filter-panel-new box" data-pjax-enable>
                          ...
                          <div class="accordion" id="sidebar">
                            ...
                            <div id="f1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <div class="range-filter clearfix">
                                  ...
                                  <input list="h-price" class="rng-hintify" maxlength="10" id="price_to_m" name="price_to" placeholder="To" type="text" value="" />
                                  <datalist id="h-price">
                                    <option value="25,000">
                                    <option value="30,000">
                                    <option value="45,000">
                                  ...
                                  <input class="btn btn-primary pull-left" name="commit" type="button" value="Go" onclick="filterRequestM()"/>
                                  <div class="clearfix"></div>
                                  <div id="pr_hint"></div>
                                </div>
                              </div>
                            ...
                            <div id="f4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <ul class="list-unstyled " onchange="filterRequestM()">
                                  ...
                                  <li title="{{$m_b->title}} Cars for Sale in Pakistan">
                                    <label class="filter-check clearfix"> <a href="#"  title="{{$m_b->title}} Cars for Sale in Pakistan">
                                      <input type="checkbox"  id="manufacture_m" name="model_m" value="{{$m_b->id}}" />
                                      {{$m_b->title}} <span class="pull-right count">{{$m_b->size}}</span> </a> </label>
                                  </li>
                                  @endforeach
                                </ul>
                            ...
                            <div id="f7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <div class="range-filter clearfix">
                                  <input list="milage-start"   class="rng-hintify"  id="mileage_fr_m" maxlength="10" name="mileage_fr" placeholder="From" type="text" value="" />
                                  <datalist id="milage-start">
                                    <option value="0">
                                    <option value="500">
                                    <option value="1,000">
...
$(function () {
   ...
   function filterRequest()
  {
   ...
   $.get('/updateFeaturedBikes', data, function (data) {
