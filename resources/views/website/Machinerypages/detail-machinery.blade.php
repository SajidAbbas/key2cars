...
<div class="clearfix"></div>
  ...
  <ol class="m-l-15">
    ...
    @endforeach
          ...
          <section>
  <div class="container">
     <h2 class="text-uppercase">Similar Heavy Machinery Ads</h2>
     <div class="row">
            
            	  @foreach($related_machinery as $r_t)
                        
                  <div class="col-sm-3 m-bottom-20 ">
                          <div class="port_item xs-m-top-30 border">
                            <div class="port_img"> <a href="{{Route('/GetMachineryDetails', ['id' => $r_t->id])}}"><img class="img-responsive rel-featured"  src="{{URL::asset('images'.$r_t->url)}}" alt="" /></a>
                              @if($r_t->featured==1)
                              <div  class="absolute-featured"> <i class="fa fa-star"></i> FEATURED </div>
                            </div>
                            @endif
                            <div class="port_caption m-top-10 car-info">
                              <h3 ><a href="{{Route('/GetMachineryDetails', ['id' => $r_t->id])}}">{{$r_t->manufacture}} {{$r_t->model}} {{$r_t->model_version}}<span style="color:#223b7b">&nbsp; {{$r_t->year}}</span></a></h3>
                              ...
                              <a href="{{Route('/GetMachineryDetails', ['id' => $r_t->id])}}" class="btn-more pull-right"  style="text-decoration:none;">View More</a>
