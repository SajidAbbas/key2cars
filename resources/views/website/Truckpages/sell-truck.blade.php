...
<div class="alert alert-danger print-error-msg" style="display:none">
                ...
                <div class="panel with-nav-tabs panel-primary">
                    <div class="panel-heading" style="border-color: #ffffff; padding-bottom:0">
                        ...
                        <ul class="nav nav-tabs">
                                ...
                                <li id="l1" class="active"><a class="tab" href="#tab1primary" data-toggle="tab">Truck Information</a></li>
                ...
                @foreach($reg_city as $r)
                  ...
                  @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" min="1" name="mileage" min="0" id="mileage" class="form-control">
                    </div> 
                  <div class="form-group">
                  <label>Seats</label>
                  <input type="number" name="seat" min="0" class="form-control" >
                </div> 
                  <div class="form-group">
                      <label>Price (Rs)</label>
                      <input type="number" min="1" id="price" min="0" name="price" class="form-control">
                    </div>
                    <!-- textarea -->
                    <div class="form-group">
      ...
      <a class="btn btn-primary pull-right" onclick="document.getElementById('l2').classList.add('active');document.getElementById('l1').classList.remove('active'); return false;" href="#tab2primary" data-toggle="tab">Next <i class="fa fa-chevron-right"></i></a>
            ...
            <a class="btn btn-primary pull-right" onclick="document.getElementById('l3').classList.add('active');document.getElementById('l2').classList.remove('active'); return false;" style='margin-top: 90px;' href="#tab3primary" data-toggle="tab">Next <i class="fa fa-chevron-right"></i></a>
                            ...
                            <div class="tab-pane active" id="tab_3" style="padding: 50px;min-height:425px;">
                      <div class="row">
                 <div class="col-lg-7">
        ...
        <div class="col-md-2 hidden-xs">
            <a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/truckad1.png')}}" alt=""/></a><br>
<a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/truckad2.png')}}" alt=""/></a><br>
<a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/truckad3.png')}}" alt=""/></a>
            </div>
           <div class="clear"></div>
...
////////Model Dropdown Update/////
    ...
    $('#make').change(function() {
        var data = { 'make': $('#make').val(),'vehicle_id':{{\App\VehicleType::Truck}} };
