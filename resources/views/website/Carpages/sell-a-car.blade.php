...
<div class="container">
        ...
        <div class=" p-top-40 row">   
        <div class="col-md-10">
        <div class="panel with-nav-tabs panel-primary">
            <div class="panel-heading tab-heading" style="border-color: #ffffff; padding-bottom:0" >
                    <ul class="nav nav-tabs">
                        <li id='l1' class="active"><a class="tab" href="#tab1primary" data-toggle="tab">Car Information</a></li>
              ...
              <option selected="selected" disabled="disabled" value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="numeric" name="mileage" min="1" id="mileage" class="form-control" >
                            </div> 
                          <div class="form-group">
                            <label>Exterior Color</label>
                            <select name="color" id="color" class="form-control select2" data-placeholder="Exterior Color" style="width: 100%;">
                            <option selected="selected" disabled="disabled" value=""></option>
      ...
      <div class="clearfix"></div>
      <a class="tab btn btn-primary pull-right" onclick="document.getElementById('l2').classList.add('active');document.getElementById('l1').classList.remove('active'); return false;" href="#tab2primary" data-toggle="tab">Next <i class="fa fa-chevron-right"></i></a>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input name="engine_capacity" min="1" id="engine_capacity" type="numeric" class="form-control" >
          </div>
             ...
             <?php $count=0;$cl=true;?>
               ...
               @if($count%3==0)
                <div class="form-group">
                  ...
                  <input type="checkbox" id="feature" style="cursor: pointer" name="feature[]" class="flat-green" value="{{$f->id}}">&emsp;<strong>{{$f->title}}</strong>
      ...
      <br>
          ...
          <label class="col-sm-4">Define Your Car Condition (<spna style="color:green;"> optional</spna> )</label>
            ...
            <label class="col-sm-12 control-label"><?=str_replace('_', ' ',$con_detail->title)?></label>
            <div class="col-sm-8">
           
            <select class="form-control select2" id="{{$con_detail->title}}" name="{{$con_detail->title}}" style="width: 100%;">
          ...
          @endforeach
            ...
            <a class="btn btn-primary pull-right" onclick="document.getElementById('l3').classList.add('active');document.getElementById('l2').classList.remove('active'); return false;" href="#tab3primary" data-toggle="tab">Next <i class="fa fa-chevron-right"></i></a>
                    
                  <!-- -->
                    </div>
                    
                    <div class="tab-pane fade" id="tab3primary" >
                    <div class="tab-pane active" id="tab_3" style="padding: 50px;min-height: 500px">
                        <div class="row">
         <div class="col-lg-7">
...
@endif
    ...
    <a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/ad1.png')}}" alt=""/><br>
    <img class="img-responsive" src="{{URL::asset('assets/car/images/ad2.png')}}" alt=""/><br>
    <img class="img-responsive" src="{{URL::asset('assets/car/images/ad3.png')}}" alt=""/>
    </a>
    </div>
...
@section('jsblock')
  ...
  <script type="text/javascript">
    var cond_list = <?php echo json_encode($condition_detail); ?>;
</script>
...
////////submiting form/////////
      /*  $('form').on('submit', function (e) {
          ...
          e.preventDefault();
           ...
           $.post('/insertCar', $('form').serialize(), function (data) {
           alert('f');
...
////////Manufacturer Dropdown Update/////
    ...
    $('#type').change(function() {
        var data = { 'type': $(this).val(),'vehicle':{{\App\VehicleType::Car}} };
...
$(document).ready(function () { 
    ...
    $(document).ajaxComplete(function(){
     ...
     data.append('city_area',$("#city_area").val());
     data.append('year',$("#year").val());
     data.append('type',$("#type").val());
     data.append('make',$("#make").val());
     data.append('model',$("#model").val());
     data.append('model_version',$("#model_version").val());
     data.append('reg_city',$("#reg_city").val());
     data.append('mileage',$("#mileage").val());
     data.append('price',$("#price").val());
     data.append('color',$("#color").val());
     data.append('description',$("#description").val());
     data.append('engine_type',$("#engine_type").val());
     data.append('engine_capacity',$("#engine_capacity").val());
     data.append('transmission',$("#transmission").val());
     data.append('assembly',$("#assembly").val());
   ...
   ///////////////////conditional details///////////////////////
    for (i = 0; i < cond_list.length; i++) { 
        if($("#"+cond_list[i]["title"]).val()!=="-1")
        {
           var name=cond_list[i]["title"];
           var value=$("#"+name).val();
