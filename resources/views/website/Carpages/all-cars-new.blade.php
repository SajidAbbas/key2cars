...
<div class="" id="main-container">
  <!--section class="search-main hidden-xs search-form">
    ...
    <div id="used-cars">
    <form method="post" id="form" action="{{route('searchCarsByAllFilters')}}#result" >
      {{ csrf_field() }}
...
<i class="fa fa fa-angle-down pull-right"></i>
          ...
          <li>
            <select class="c-form__select_48" name="mileage_fr"  style="width: 48%;">
              <option value="" disabled="disabled">From</option>
              <option value="10000">10,000 km</option>
              <option value="20000">20,000 km</option>
              <option value="30000">30,000 km</option>
            </select>
            <select class="c-form__select_48 pull-right" name="mileage_to"  style="width: 48%;">
        ...
        @endforeach
          ...
          <li>
            <select class="c-form__select_48" name="capacity_fr"  style="width: 48%;">
              <option value="" disabled="disabled">From</option>
              <option value="600">600 cc</option>
              <option value="800">800 cc</option>
            </select>
            <select class="c-form__select_48 pull-right" name="capacity_to"  style="width: 48%;" >
              <option value="" disabled="disabled">To</option>
              <option value="600">600 cc</option>
              <option value="800">800 cc</option>
          ...
          <li>
            <select class="c-form__select_48"  name="year_fr" style="width: 48%;">
              <option value="" disabled="disabled">From</option>
...
@endforeach
            ...
            <select class="c-form__select_48 pull-right"   name="year_to" style="width: 48%;">
              <option value="" disabled="disabled">To</option>
...
@endforeach
        ...
        <ul class="search-fields search-fields3 clearfix">
          <li>
            <select style="background:#FFFFFF !important;" name="body_type"  class="chzn-select c-form__select" tabindex="1">
        ...
        @endforeach
          ...
          <li>
            <select class="chzn-select c-form__select"  name="color" >
...
@endforeach
 <i class="fa fa fa-angle-down pull-right"></i>
          ...
          <li>
            <select name="reg_city"  class="chzn-select c-form__select">
       ...
       @endforeach
        ...
        <ul class="search-fields search-fields3 clearfix">
          <li>
            <select name="assembly" class="chzn-select c-form__select">
           ...
           @foreach($new_cars as $n_c)
                ...
                <div class="col-sm-3 ">
                          <div class="port_item xs-m-top-30 border bg-white">
                           <div class="port_img"><a href="{{Route('/GetCarDetails', ['id' => $n_c->id])}}"><img class="img-responsive rel-featured"  src="{{ URL ::asset('images'.$n_c->url) }}" alt="" /></a>
                       @if($n_c->featured==1)
                              <div  class="absolute-featured"> <i class="fa fa-star"></i> FEATURED </div>
                            @endif
                              </div>
                           <div class="port_caption m-top-10 car-info">
                           <h3 ><a href="{{Route('/GetCarDetails', ['id' => $n_c->id])}}">{{$n_c->manufacture}} {{$n_c->model}} {{$n_c->model_version}}&nbsp; {{$n_c->year}}</a></h3>
                             <h6 style="color:#ff4436">PKR <span style="color:#ff4436">{{$n_c->price}}</span></h6>
                       @if($n_c->condition==\App\VehicleType::New_Vehicle)
                        <h6>Condition: New</h6>
                        @elseif($n_c->condition==\App\VehicleType::Almost_New_Vehicle)
                         <h6>Condition: Almost New</h6>
                        @else
                         <h6>Condition: Used</h6>
                        @endif
                        <div class="pull-right"><h6><i class="fa fa-map-marker"></i>&nbsp; {{$n_c->city}}</h6></div>
                        <a href="{{Route('/GetCarDetails', ['id' => $n_c->id])}}" class="btn-more"  style="text-decoration:none;">View More</a>
    ...
    <div class="used-car-search-results">
      ...
      <div class="search-page-new m-bottom-40">
        <div class="row"> 
                  ...
                  <div id="message1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                      <div class="range-filter clearfix" >
                        <input list="l-price"  class="rng-hintify" id="price_fr" name="price_fr" placeholder="From" type="text" value="" />
                        <datalist id="l-price">
                        ...
                        <input list="h-price"  class="rng-hintify" maxlength="10" id="price_to" name="price_to" placeholder="To" type="text" value="" />
                        <datalist id="h-price">
                          <option value="400,000">
                          <option value="600,000">
                          <option value="800,000">
          ...
          <div class=" search-listing col-md-9 " id="result">
                        ...
                        <div class="filter-panel-new box" data-pjax-enable>
                          ...
                          <div class="accordion" id="sidebar">
                            ...
                            <div id="f2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <div class="range-filter clearfix" >
                                  <input list="l-price" name="l-price" class="rng-hintify" id="price_fr_m" name="price_fr_m" placeholder="From" type="text" value="" />
                                  <datalist id="l-price">
                                    <option value="200,000">
                                    <option value="400,000">
                                    <option value="600,000">
                                  ...
                                  <input list="h-price"  class="rng-hintify" maxlength="10" id="price_to_m" name="price_to_m" placeholder="To" type="text" value="" />
                                  <datalist id="h-price">
                                    <option value="400,000">
                                    <option value="600,000">
                                    <option value="800,000">
                            ...
                            <div id="f3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <div class="range-filter clearfix">
                                  <input list="year-start" name="year-start" class="rng-hintify"  id="year_fr_m" maxlength="10" name="year_fr_m" placeholder="From" type="text" value="" />
                                  <datalist id="year-start">
                                    <option value="2001">
                                    <option value="2002">
                                    <option value="2003">
                                  ...
                                  <input list="year-end" name="year-end" class="rng-hintify"  id="year_to_m" maxlength="10" name="year_to_m" placeholder="To" type="text" value="" />
                                  <datalist id="year-end">
                                    <option value="2002">
                                    <option value="2003">
                                    <option value="2004">
                            ...
                            <div id="f12" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                <div class="range-filter clearfix">
                                  <input list="cc-start"  class="rng-hintify"  id="capacity_fr_m" maxlength="10" name="capacity_fr_m" placeholder="From" type="text" value="" />
                                  <datalist id="cc-start">
                                    <option value="600">
                                    <option value="700">
                                    <option value="800">
                                  ...
                                  <input list="cc-end"  class="rng-hintify"  id="capacity_to_m" maxlength="10" name="capacity_to_m" placeholder="To" type="text" value="" />
                                  <datalist id="cc-end">
                                    <option value="600">
                                    <option value="700">
                                    <option value="800">
        ...
        <div data-pjax-enable id="p_l">
          <ul class="pagination search-pagi" id="paginate">
              {{ $all_cars->fragment("result")->render() }}
          </ul>
        </div>
               @else
...
$(function () {
 ...
 var condition=[];
   ...
   $.get('/updateAllCars', data, function (data) {
       
        
        document.getElementById("paginate_result").innerHTML = data;
        
        document.getElementById("paginate").innerHTML=document.getElementById("link").innerHTML;
...
//console.log(data);
   ...
   $.get('/updateAllCars', data, function (data) {
       ...
       document.getElementById("cars").innerHTML = element;
         ...
         window.location.hash = '#paginate_result';
      });
