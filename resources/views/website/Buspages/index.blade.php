...
@section('title')
Bus for Sale in Pakistan | Key2Cars
@endsection
...
<div class="" id="main-container">
  <form class="form-horizontal hidden-lg hidden-md hidden-sm " id="searchForm" method="post" action="{{route('searchBusByAllFilters')}}#result" role="form">
     {{ csrf_field() }}
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      
      <h2 style="text-align:center;">Find Buses for Sale in Pakistan</h2>
    <div class="form-group pull-left col-lg-12  col-md-12 col-sm-12 col-xs-12 " style="margin-left:0;">
      <div class="row">
        <select style="background:#FFFFFF !important;" name="make" id="make_m" class="chzn-select c-form__select" tabindex="1" >
            <option  class="pr-text" value="-1" >Bus Make</option>
    ...
    <div class="form-group pull-right col-lg-12  col-md-12 col-sm-12 col-xs-12 " style="margin-right:0;">
      <div class=" row">
       <select style="background:#FFFFFF !important;" name="model" id="model_m" class="chzn-select c-form__select pointer"  >
            <option   value="-1" >Bus Model</option>
          </select>
      </div>
    </div>
    <div class="clear"></div>
...
<div class="" id="main-container">
  <section class="search-main hidden-xs search-form-bus" >
    <div class="container">
    <div class="search-main " style="position: relative;">
    <div id="top-search-heading" class="head">
      <h1>Find Buses in Pakistan</h1>
    </div>
    <div class="" tabindex="0">
    <div id="used-cars">
    <form method="post" action="{{route('searchBusByAllFilters')}}#result" >
      {{ csrf_field() }}
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<i class="fa fa fa-angle-down pull-right"></i>
  ...
  <div id="wait" style="display:none;width:69px;height:89px;border:1px solid black;position:absolute;top:50%;left:50%;padding:2px;"><img src="{{URL::asset('assets/car/images/demo_wait.gif')}}" width="64" height="64" /><br>
    Loading..</div>
    @if(!$new_busses->isEmpty())
  <section id="product" class=" product m-bottom-20 clearfix">
    <div class="container">
      <div class="main_product ">
        <div class="fix">
          <h2 class="text-uppercase">Featured Buses for Sale</h2>
        </div>
        <div id="carousel-example-generic" class="carousel" data-ride="carousel"> 
          ...
          <!-- Wrapper for slides -->
          <?php $count = 1; ?>
          <div class="carousel-inner" role="listbox" > @foreach($new_busses as $n_b)
              ...
              <div class="item"> @endif
                <div class="col-sm-3 ">
                  <div class="port_item xs-m-top-30 border bg-white">
                    <div class="port_img"><a href="{{Route('/GetBusDetails', ['id' => $n_b->id])}}"><img class="img-responsive rel-featured"  src="{{ URL ::asset('images'.$n_b->url) }}" alt="" /></a> @if($n_b->featured==1)
                      <div  class="absolute-featured"> <i class="fa fa-star"></i> FEATURED </div>
                      @endif </div>
                    <div class="port_caption m-top-10 car-info">
                      <h3 ><a href="{{Route('/GetBusDetails', ['id' => $n_b->id])}}">{{$n_b->manufacture}} {{$n_b->model}} {{$n_b->model_version}}&nbsp; {{$n_b->year}}</a></h3>
                      ...
                      <a href="{{Route('/GetBusDetails', ['id' => $n_b->id])}}" class="btn-more"  style="text-decoration:none;">View More</a> 
...
<section>
  <div class="container">
    <div class="used-car-search-results">
      <div class="col-sm-3 hidden-xs"><img src="{{URL::asset('assets/car/images/busad1.png')}}"></div>
                  ...
                  <div id="message4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                      <ul class="list-unstyled " onchange="filterRequest()">
                        @foreach($manufacture_busses as $m_b)
              ...
              <div class="panel-body row" style="background: #f5f5f5;">
                ...
                @endif
                  ...
                  <div class="col-sm-12 border m-bottom-20 update-box">
                    ...
                    <div class="col-xs-8"><a href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}">
                      ...
                      <a class="pull-right btn-more mobile-button hidden-lg hidden-md hidden-sm" href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}"  style="text-decoration:none;">View More</a>
                      <div class="clearfix"></div>
                      ...
                      <a class="pull-right hidden-xs btn-more" href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}"  style="text-decoration:none;">View More</a> </div>
                  </div>
                  @endforeach </div>
                ...
                <div class="col-sm-4 col-xs-12 m-top-20">
                  <div class="port_item border">
                    <div class="port_item xs-m-top-30 border bg-white">
                      <div class="port_img"><a href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}"><img class="img-responsive rel-featured"  src="{{ URL ::asset('images'.$a_c->url) }}" alt="" /></a> @if($a_c->featured==1)
                        <div  class="absolute-featured"> <i class="fa fa-star"></i> FEATURED </div>
                        @endif </div>
                      <div class="port_caption m-top-10 car-info">
                        <h3 ><a href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}">{{$a_c->manufacture}} {{$a_c->model}}&nbsp; {{$a_c->year}}</a></h3>
                        ...
                        <a href="{{Route('/GetBusDetails', ['id' => $a_c->id])}}" class="btn-more"  style="text-decoration:none;">View More</a> 
                        <!--<div class="featured-ribbon ribbon"> <i class="fa fa-star"></i>FEATURED </div>--> 
                      </div>
                    </div>
                  </div>
...
var name=$("#name").val();
 ...
 $.get('/updateAllBuses', data, function (data) {
