                ...
                @foreach($reg_city as $r)
                  ...
                  @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" min="1" name="mileage" id="mileage" class="form-control">
                    </div> 
                  <div class="form-group">
                  <label>Seats</label>
                  <input type="number" min="1" name="seat" class="form-control" >
                </div> 
                  <div class="form-group">
      ...
      <a class="btn btn-primary pull-right" onclick="document.getElementById('l2').classList.add('active');document.getElementById('l1').classList.remove('active'); return false;" href="#tab2primary" data-toggle="tab">Next <i class="fa fa-chevron-right"></i></a>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                   ...
                   <select name="engine_type" min="1" id="engine_type" data-placeholder="Engine Type" class="form-control select2"  style="width: 100%;">
                <option selected="selected" disabled="disabled" value=""></option>
        ...
        <div class="col-md-2 hidden-xs ">
            <a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/busad1.png')}}" alt=""/></a><br>
<a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/busad2.png')}}" alt=""/></a><br>
<a href="#"><img class="img-responsive" src="{{URL::asset('assets/car/images/busad3.png')}}" alt=""/></a>
            </div>
...
////////Model Dropdown Update/////
    ...
    $('#make').change(function() {
        var data = { 'make': $('#make').val(),'vehicle_id':{{\App\VehicleType::Bus}} };
