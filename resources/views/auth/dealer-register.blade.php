    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong>Dealer Account</string></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" enctype = "multipart/form-data" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('img_url') ? ' has-error' : '' }}">
                            <label for="img_url" class="col-md-4 control-label">Image</label>

                            <div class="col-md-6">
                                <input id="img_url" type="file" class="form-control" name="img_url" value="{{ old('img_url') }}">
                        ...
                        <input type="hidden" name="role_id" value="{{App\Role::Dealer}}">
