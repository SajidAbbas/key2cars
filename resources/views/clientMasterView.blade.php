  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::path() == 'admin/dashboard' ? 'active' : '' }}">
         <a href="{{URL('/admin')}}">
          ...
          <ul class="treeview-menu">
              <li class="{{ Request::is( 'adminAds') ? 'active' : '' }}"><a href="{{ route('adminAds') }}"><i class="fa fa-circle-o"></i> Ads/Vehicle</a></li>
              <li ><a href="{{ route('adminAdsAccessories') }}"><i class="fa fa-circle-o"></i> Ads/Accesories</a></li>
