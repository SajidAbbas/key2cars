...
<title>Admin | Model Version</title>
@endsection
...
<a href="{{route('addModelVersion') }}" class="btn bg-blue">
...
Delete (selected)
    ...
    <section class="content">
      ...
      <div class="box box-default" style="padding: 40px;">
        ...
        <form method="post" action="{{route('searchModelVersion')}}">
          {{ csrf_field() }}
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="row">
                <div class="col-md-6">
            <div class="input-group input-group-md">
                <td>    <select name="model" class="form-control select2" style="width: 100%;"  >
                  <option selected="selected" disabled value="">By Model</option>
      ...
      <div class="col-md-12 alert alert-danger"  id="error" style="display: none;" >
       ...
       <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Model Version</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td style=" vertical-align: middle"> {{$d->year}}</td>   
                  <td style=" vertical-align: middle"><a class="btn btn-default" href="{{Route('editModelVersion', ['id' => $d->id])}}"><i class="fa fa-pencil"></i> Edit</a>
                  </td>
                </tr>
                <?php $serial++;?>
                @endforeach
...
function deleteRecord(ids)
  {
    ...
    buttons: {
        confirm: function () {
      var data = { 'id': ids };
        $.get('deleteModelVersion', data, function (data) {
