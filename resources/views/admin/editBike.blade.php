      ...
      <!-- /.box -->
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"><strong> Bike Information</strong></a></li>
            ...
            @foreach($result as $r)
            <form  method="post" id="form" action="{{ route('updateBike')}}"   enctype = "multipart/form-data" autocomplete="off">
             {{ csrf_field() }}
